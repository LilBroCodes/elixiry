package org.lilbrocodes.elixiry.block;
...
import static org.lilbrocodes.elixiry.block.entity.WitchCauldronBlockEntity.StirDirection.*;
...
public class WitchCauldron extends BlockWithEntity {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (stack.getItem() == Items.GLASS_BOTTLE && state.get(WitchCauldron.HAS_FLUID) && be.canTakePotion()) {
